...
from include.local_setup.src.pipelines.legislativo.senado.senado_votos_orientacao import (
    extract,
    transform,
)
...
logger = logging.getLogger("DAG: senado_votos_orientacao")


@dag(
    dag_id="senado_votos_orientacao_pipeline",
