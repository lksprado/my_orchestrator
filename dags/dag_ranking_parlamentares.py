...
from include.local_setup.src.pipelines.legislativo.ranking_politicos.ranking_parlamentares import (
    transform as transform_parlamentares,
)
...
_CONFIG_FILE = (
    ...
    / "ranking_politicos" / "ranking_politicos_config.yml"
)
...
def parlamentares_pipeline():
    ...
    cfg = PipelineConfig(**load_source_config(_CONFIG_FILE, source="parlamentares", env="airflow"))
    target = cfg.db_table
